...
from skill_companion_audit import audit_companion_references, audit_host_flavor_metadata
...
flavor_issues = audit_host_flavor_metadata(skills_root)
assert not flavor_issues, flavor_issues
