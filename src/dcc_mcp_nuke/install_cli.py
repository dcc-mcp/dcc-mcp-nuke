"""Agent-first installer entry point for Nuke."""
...
from dcc_mcp_nuke._installer import COMMAND, run_lifecycle
...
def main(argv: Optional[Sequence[str]] = None) -> int:
    """Run the Nuke lifecycle command."""
    ...
    if args.as_json:
        ...
        print(f"Nuke {args.verb}: {outcome.result['status']}")
